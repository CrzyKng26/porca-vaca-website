...
export default function StoryChapter() {
  return (
    <section id="story" className="relative z-20 w-full bg-bone py-24 md:py-40 px-6 md:px-12 flex flex-col items-center justify-center border-t border-obsidian/10">
      <div className="max-w-[1440px] w-full grid grid-cols-1 md:grid-cols-12 gap-12 relative z-10">
        <div className="md:col-span-8 flex flex-col justify-center">
          <h2 className="font-display text-display-md text-obsidian leading-[0.9] uppercase tracking-tighter mb-8">
