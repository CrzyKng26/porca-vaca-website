...
const carouselItems = [
  {
    ...
    tag: "RED WINE JUS",
    src: "https://images.unsplash.com/photo-1544025162-d76694265947?q=60&w=800&auto=format&fit=crop"
  },
  {
    id: 2,
    name: "BARBECUE PORK RIBS",
    tag: "SLOW ROASTED",
    src: "https://images.unsplash.com/photo-1529193591184-b1d58069ecdd?q=60&w=800&auto=format&fit=crop"
  },
  {
    id: 3,
    name: "SMASH CHEESEBURGER",
    tag: "MAILLARD CRUST",
    src: "https://images.unsplash.com/photo-1568901346375-23c9450c58cd?q=60&w=800&auto=format&fit=crop"
  },
  {
    id: 4,
    name: "TRUFFLE BURRATA PIZZA",
    tag: "WOOD-FIRED",
    src: "https://images.unsplash.com/photo-1565299624946-b28f40a0ae38?q=60&w=800&auto=format&fit=crop"
  },
  {
    id: 5,
          ...
          {repeatedItems.map((item, index) => (
            ...
            >
              ...
              <div className="absolute inset-x-0 bottom-0 p-6 lg:p-8 flex flex-col items-center lg:transform lg:translate-y-4 lg:group-hover/card:translate-y-0 transition-transform duration-[400ms] pointer-events-none">
                <div className="text-[10px] tracking-widest uppercase text-ember mb-2 lg:mb-3">{item.tag}</div>
